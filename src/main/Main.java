...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (nastaviProgram) {
			System.out.println("Izaberite opciju/n1. Pregled/n2. Unos nove prijave/n3. Izmena/4. Kraj programa.");
			int opcija = in.nextInt();

			switch (opcija) {
			case 1:
				System.out.println("Izaberite opciju/na. Pregled svih prijava/nb. Pregled svih studenata/nc. "
						+ "Pregled svih prijava za trazenog studenta/nd. Pregled svih studenata koji su polozili odredjeni predmet/ne. Povratak u glavni meni");
				...
				case "c":
					...
					break;
				case "d":
					pregledStudenataKojiSuPolozili(osnoveProgramiranjaJava);
					break;
				case "e":
					break;
				}
	...
	public static void pregledStudenataKojiSuPolozili(Predmet predmet) {
		System.out.println(predmet.getStudentiKojiSuPolozili());
	}
